...
var hyvorTalk = (function ($) {
	...
	*/
    ...
    function saveSettings() {
        ...
        var loadingModeSelect = document.getElementById(
                "ht-loading-mode-select"
            ),
            loadingMode = loadingModeSelect
                ? loadingModeSelect.options[loadingModeSelect.selectedIndex]
                      .value
                : null;

        if (loadingMode) data.loadingMode = loadingMode;
        ...
        $.ajax({
            ...
            success: function (json) {
                if (json && json.status === true) location.reload();
            },
        });
    }
